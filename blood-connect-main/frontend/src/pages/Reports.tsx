...
const stats = [
  { icon: Heart, label: "Total Donations", value: "0", trend: "+0%" },
  { icon: Droplet, label: "New Donors", value: "0", trend: "+0%" },
  { icon: Building2, label: "Total Camps", value: "0", trend: "+0%" },
  { icon: TrendingUp, label: "Lives Impacted", value: "0", trend: "+0%" },
];
  ...
  <AppLayout title="Reports & Analytics">
        ...
        <div className="flex items-center gap-6">
          <div className="relative h-40 w-40">
            <div className="absolute inset-0 rounded-full" style={{
              background: `conic-gradient(hsl(var(--primary)) 0 100%)`
            }} />
          ...
          <div className="space-y-2 text-sm flex-1">
            {[["O+","0%"],["A+","0%"],["B+","0%"],["AB+","0%"],["Others","0%"]].map(([k,v]) => (
    ...
    <Card className="p-6 border-0 shadow-card mt-6">
      ...
      <div className="p-8 text-center text-sm text-muted-foreground">
        No donors yet. Donor rankings will appear here once donations are recorded.
      </div>
    </Card>
  </AppLayout>
);
